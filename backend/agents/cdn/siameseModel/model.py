...
class SiameseBERT(nn.Module):
    ...
    def classify_embeddings(self, emb1: torch.Tensor, emb2: torch.Tensor) -> torch.Tensor:
        """Classify using pre-computed embeddings"""
    ...
    def forward(self, input_ids1, attention_mask1, input_ids2, attention_mask2):
        ...
        return self.classify_embeddings(emb1, emb2)